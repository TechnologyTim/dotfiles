...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2023-08-22 12:12:05" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2023-08-22 12:12:05" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2023-08-22 12:12:05" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2023-08-22 12:12:05" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2023-08-22 12:12:05" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2023-08-22 12:12:05" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2023-08-22 12:12:05" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "helm" ("2023-08-22 12:12:05" ("helm-core" "wfnames" "popup") (:type git :flavor melpa :files ("*.el" "emacs-helm.sh" (:exclude "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core.el") "helm-pkg.el") :host github :repo "emacs-helm/helm" :package "helm" :local-repo "helm")) "helm-core" ("2023-08-22 12:12:05" ("emacs" "async") (:flavor melpa :files ("helm-core.el" "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core-pkg.el") :package "helm-core" :local-repo "helm" :type git :repo "emacs-helm/helm" :host github)) "async" ("2023-08-22 12:12:05" ("emacs") (:type git :flavor melpa :host github :repo "jwiegley/emacs-async" :package "async" :local-repo "emacs-async")) "wfnames" ("2023-08-22 12:12:05" ("emacs") (:type git :flavor melpa :host github :repo "thierryvolpiatto/wfnames" :package "wfnames" :local-repo "wfnames")) "popup" ("2023-08-22 12:12:05" ("emacs") (:type git :flavor melpa :host github :repo "auto-complete/popup-el" :package "popup" :local-repo "popup-el"))))
...
(fn FILES &optional (DISPLAY-FN #\\='switch-to-buffer) APPEND)" nil nil) (register-definition-prefixes "wfnames" '("wfnames-")) (provide 'wfnames-autoloads)) "popup" ((popup popup-autoloads) (register-definition-prefixes "popup" '("popup-")) (provide 'popup-autoloads)) "helm" ((helm-external helm-dabbrev helm-color helm-x-files helm-command helm helm-files helm-semantic helm-comint helm-net helm-global-bindings helm-bookmark helm-eshell helm-for-files helm-sys helm-packages helm-occur \.dir-locals helm-ring helm-locate helm-utils helm-epa helm-buffers helm-imenu helm-elisp helm-font helm-grep helm-tags helm-fd helm-help helm-types helm-regexp helm-misc helm-info helm-eval helm-easymenu helm-autoloads helm-adaptive helm-find helm-id-utils helm-shell helm-man helm-mode) (defvar helm-adaptive-mode nil "Non-nil if Helm-Adaptive mode is enabled.
...
(fn SYM &optional (NAME \"describe-function\") (END-COLUMN 72))" nil nil) (autoload 'helm-complete-file-name-at-point "helm-elisp" "Preconfigured Helm to complete file name at point.
...
To use this bind it to a key in `isearch-mode-map'." t nil) (register-definition-prefixes "helm-occur" '("helm-")) (autoload 'helm-packages "helm-packages" "Helm interface to manage packages.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "helm-packages" '("helm-packages-")) (autoload 'helm-regexp "helm-regexp" "Preconfigured helm to build regexps.
...
See (info \"(emacs) Keyboard Macros\") for detailed infos." t nil) (register-definition-prefixes "helm-ring" '("helm-")) (autoload 'helm-semantic "helm-semantic" "Preconfigured `helm' for `semantic'.
...
("org-elpa" "melpa" "gnu-elpa-mirror" "nongnu-elpa" "el-get" "emacsmirror-mirror" "straight" "emacs" "helm" "helm-core" "async" "wfnames" "popup")
